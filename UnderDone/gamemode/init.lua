...
AddCSLuaFile("MainMenuTabs/inventory.lua")
AddCSLuaFile("MainMenuTabs/players.lua")
AddCSLuaFile("VGUIObjects/FListItem.lua")
AddCSLuaFile("VGUIObjects/FIconItem.lua")
AddCSLuaFile("VGUIObjects/FMultiLineLabel.lua")
include("shared.lua")
include("items.lua")
