...
function GM:HUDPaint()
	...
	surface.DrawRect(SW- 320,SH - 70,280/((UpgradeLevels[Locker[1].Weapon].MaxPower)/(Locker[1].pwrlvl)),5)
	surface.DrawRect(SW- 320,SH - 55,280/((UpgradeLevels[Locker[1].Weapon].MaxAccuracy)/(Locker[1].acclvl)),5)
	surface.DrawRect(SW- 320,SH - 40,280/((UpgradeLevels[Locker[1].Weapon].MaxFiringSpeed)/(Locker[1].spdlvl)),5)
	surface.DrawRect(SW- 320,SH - 25,280/((UpgradeLevels[Locker[1].Weapon].MaxClipSize)/(Locker[1].clplvl)),5)
	surface.DrawRect(SW- 320,SH - 10,280/((UpgradeLevels[Locker[1].Weapon].MaxReloadSpeed)/(Locker[1].reslvl)),5)
end