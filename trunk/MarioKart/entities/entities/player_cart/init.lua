...
function ENT:Initialize()
	...
	self.BodyFrame:SetCollisionGroup(GROUP_NONE)
	...
	self.BackWheel1:SetCollisionGroup(GROUP_NONE)
	...
	self.BackWheel2:SetCollisionGroup(GROUP_NONE)
	...
	self.frontWheel1:SetCollisionGroup(GROUP_NONE)
	...
	self.frontWheel2:SetCollisionGroup(GROUP_NONE)
	...
	self.SteerWheel1:SetCollisionGroup(GROUP_NONE)
