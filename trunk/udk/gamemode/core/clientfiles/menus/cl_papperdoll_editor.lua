...
function GM.PapperDollEditor.OpenPapperDollEditor()
	local frmPapperDollFrame = CreateGenericFrame("Papper Doll Editor", true, true)
	frmPapperDollFrame:SetPos(50, 50)
	frmPapperDollFrame:SetSize(350, 450)
	...
	local pnlControlsList = CreateGenericList(frmPapperDollFrame, 5, false, true)
	pnlControlsList:SetPos(5, 25)
	pnlControlsList:SetSize(frmPapperDollFrame:GetWide() - 10, frmPapperDollFrame:GetTall() - 30)
	...
	local btnPrintButton = CreateGenericButton(nil, "Copy Info to Clipboard")
